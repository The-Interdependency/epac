...
class TestInventory:
    """Bind successful calls to the complete collection in this pytest run."""
...
def verify_test_evidence(xml_path, collected, passed):
...
def main() -> None:
    ...
    test_count = verify_test_evidence(xml_path, inventory.collected, inventory.passed)
